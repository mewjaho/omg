...
<html lang="en">
  ...
  <nav
    ...
    <br />
    <h1 style="text-align:center; font-weight: bold; font-family: Bai Jamjuree;"
    >การนอนซ้ำโรงพยาบาล</h1>
    <?php
require('dbm.php');
$HN=$_GET['HN'];
$sql = "SELECT * FROM Nurse WHERE HN=$HN";
        ...
        <div class="row">
          <div class="col-sm-8">
            <div class="card">
              <div
                class="card-body"
                style="background-color: rgb(233, 198, 233)"
              >
                <div class="row">
